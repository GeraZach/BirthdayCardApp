        ...
        setContent {
            BirthdayCardAppTheme {
                ...
                Surface(
                    ...
                    BackgroundImage(name = "George", from = "Emma")
                }
            }
        }
    }
...
@Composable
fun BackgroundImage(name: String, from: String, modifier: Modifier = Modifier) {
    val image = painterResource(R.drawable.bdaycardbackground)
...
fun BirthdayCardPreview() {
    BirthdayCardAppTheme {
        BackgroundImage(name = "123", from = "123")
    }
}